...
from word_representation_layer4 import word_representation_layer4
from word_representation_layer5 import word_representation_layer5

class ppdb_char_word_model(object):
	...
	if params.nntype == 'word_char1':
	    ...
	    l_word_representation = word_representation_layer4([l_emb, l_char_emb, l_char_mask])
	elif params.nntype == 'word_char3':
            l_word_representation = word_representation_layer5([l_emb, l_char_emb, l_char_mask])
	else:

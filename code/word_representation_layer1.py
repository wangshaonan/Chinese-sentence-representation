...
class word_representation_layer1(lasagne.layers.MergeLayer):
    def __init__(self, incoming, num_units=300, W=lasagne.init.Normal(), b=lasagne.init.Normal(), **kwargs):
        super(word_representation_layer1, self).__init__(incoming, **kwargs)
	...
	attention_weight = 1+attention_weight
